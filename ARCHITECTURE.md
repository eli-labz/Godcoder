...
Godcoder is a polyglot monorepo built around one idea: **the agent core is the
...
to the endpoint you configured in Settings. No Godcoder-operated server sits
in between.
