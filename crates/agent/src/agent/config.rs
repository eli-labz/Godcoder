...
pub struct AgentConfig {
    ...
    /// Extra tools registered into the session regardless of mode (e.g. tools
    /// discovered from configured MCP servers). Supplied by the host layer.
    pub extra_tools: Vec<Arc<dyn crate::tool::Tool>>,
}
